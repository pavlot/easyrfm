...
namespace std
{
    ...
    public:
        ...
        inline constexpr initializer_list() noexcept : __begin_(nullptr), __size_(0) {}
        ...
        inline constexpr const _Ep *end() const noexcept { return __begin_ + __size_; }
    };

    template <class _Ep>
    inline constexpr const _Ep *
